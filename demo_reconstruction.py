#python demo_reconstruction.py  -p grasp_params_l0125.json -d loader.csv -o /home/ch233932/Downloads/dce_mri_grasp-master -sid sub-1
#python demo_reconstruction.py  -p grasp_params_l0125.json -d loader.csv -o /home/ch233932/Downloads/learnable_grasp -sid sub-1
...
for idx_s, dat_idx in enumerate(idx_sub):
    ...
    xk_hat = copy(xk) # 76 * [448, 448] complex64
